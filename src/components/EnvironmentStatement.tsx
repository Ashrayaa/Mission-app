        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-[#b6b6b6]">
              ...
              the carbon footprint of the network. Unless directly disclosed
              none of the projects we support will operate through Proof of
              Work.
            </p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-[#b6b6b6]">
              ...
              the need for physical hardware and lowering the carbon footprint
              of the network. Other benefits include increased scalability,
              faster transaction speeds, and improved accessibility. Overall,
              cloud computing provides an eco-friendly and efficient solution
              for validating and recording transactions on PoS blockchains.
            </p>
