...
const Services = (props: Props) => {
  return (
    <div>
      <div className="p-6">
        <h1 className="text-5xl font-extrabold my-6">SERVICES</h1>
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-[#b6b6b6]">
              ...
              according to the underlying project&apos;s protocol and
              tokenomics.
            </p>
          ...
          {/* 5 */}
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-bold">NODE BUILD TEMPLATES</h2>
            <p className="text-[#b6b6b6]">
          ...
          {/* 6. blockchain */}
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-bold">BLOCKCHAIN SCALABILITY</h2>
            <p className="text-[#b6b6b6]">
              Leverage scalable blockchain infrastructure and a substantial and
              growing community of committed datapreneurs for rapid and
              effective scaling of blockchain-based applications. Maintain high
              performance and security in a decentralised approach.
            </p>
